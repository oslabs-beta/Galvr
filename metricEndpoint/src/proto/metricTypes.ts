...
export type ParsedKeyValue = Record<string, AnyValue>;
...
export interface ParsedMetric {
  ...
  description: string;
  unit: string;
  gauge?: ParsedGauge | Gauge | undefined;
  sum?: ParsedSum | Sum | undefined;
  histogram?: ParsedHistogram | Histogram | undefined;
  exponentialHistogram?:
    | ParsedExponentialHistogram
    | ExponentialHistogram
    | undefined;
  summary?: ParsedSummary | Summary | undefined;
}
