...
export const MetricsData = {
  ...
  toJSON(message: MetricsData): unknown {
    ...
    if (message.resourceMetrics) {
      obj.resourceMetrics = message.resourceMetrics.map((e) => e ? ResourceMetrics.toJSON(e) : undefined);
    } else {
      obj.resourceMetrics = [];
    }
    return obj;
...
export const ResourceMetrics = {
  ...
  toJSON(message: ResourceMetrics): unknown {
    ...
    if (message.scopeMetrics) {
      obj.scopeMetrics = message.scopeMetrics.map((e) => e ? ScopeMetrics.toJSON(e) : undefined);
    } else {
      obj.scopeMetrics = [];
    }
...
export const Metric = {
  ...
  toJSON(message: Metric): unknown {
    ...
    message.sum !== undefined && (obj.sum = message.sum ? Sum.toJSON(message.sum) : undefined);
    message.histogram !== undefined &&
      (obj.histogram = message.histogram ? Histogram.toJSON(message.histogram) : undefined);
    message.exponentialHistogram !== undefined && (obj.exponentialHistogram = message.exponentialHistogram
      ? ExponentialHistogram.toJSON(message.exponentialHistogram)
      : undefined);
    message.summary !== undefined && (obj.summary = message.summary ? Summary.toJSON(message.summary) : undefined);
    return obj;
  },
...
export const Gauge = {
  ...
  toJSON(message: Gauge): unknown {
    ...
    if (message.dataPoints) {
      obj.dataPoints = message.dataPoints.map((e) => e ? NumberDataPoint.toJSON(e) : undefined);
    } else {
      obj.dataPoints = [];
    }
    return obj;
...
export const Sum = {
  ...
  fromJSON(object: any): Sum {
    return {
      ...
      aggregationTemporality: isSet(object.aggregationTemporality)
        ...
        : 0,
      isMonotonic: isSet(object.isMonotonic) ? Boolean(object.isMonotonic) : false,
    };
  },
  ...
  toJSON(message: Sum): unknown {
    ...
    message.isMonotonic !== undefined && (obj.isMonotonic = message.isMonotonic);
    return obj;
  },
...
export const Histogram = {
  ...
  toJSON(message: Histogram): unknown {
    const obj: any = {};
    if (message.dataPoints) {
      obj.dataPoints = message.dataPoints.map((e) => e ? HistogramDataPoint.toJSON(e) : undefined);
    } else {
      obj.dataPoints = [];
    }
    message.aggregationTemporality !== undefined &&
...
export const ExponentialHistogram = {
  ...
  toJSON(message: ExponentialHistogram): unknown {
    const obj: any = {};
    if (message.dataPoints) {
      obj.dataPoints = message.dataPoints.map((e) => e ? ExponentialHistogramDataPoint.toJSON(e) : undefined);
    } else {
      obj.dataPoints = [];
    }
    message.aggregationTemporality !== undefined &&
...
export const Summary = {
  ...
  toJSON(message: Summary): unknown {
    const obj: any = {};
    if (message.dataPoints) {
      obj.dataPoints = message.dataPoints.map((e) => e ? SummaryDataPoint.toJSON(e) : undefined);
    } else {
      obj.dataPoints = [];
    }
    return obj;
...
export const NumberDataPoint = {
  ...
  fromJSON(object: any): NumberDataPoint {
    return {
      ...
      exemplars: Array.isArray(object?.exemplars) ? object.exemplars.map((e: any) => Exemplar.fromJSON(e)) : [],
  ...
  toJSON(message: NumberDataPoint): unknown {
    ...
    if (message.exemplars) {
      obj.exemplars = message.exemplars.map((e) => e ? Exemplar.toJSON(e) : undefined);
    } else {
      obj.exemplars = [];
    }
...
export const HistogramDataPoint = {
  ...
  fromJSON(object: any): HistogramDataPoint {
    return {
      ...
      explicitBounds: Array.isArray(object?.explicitBounds) ? object.explicitBounds.map((e: any) => Number(e)) : [],
      exemplars: Array.isArray(object?.exemplars) ? object.exemplars.map((e: any) => Exemplar.fromJSON(e)) : [],
      flags: isSet(object.flags) ? Number(object.flags) : 0,
...
export const ExponentialHistogramDataPoint = {
  ...
  fromJSON(object: any): ExponentialHistogramDataPoint {
    return {
      ...
      min: isSet(object.min) ? Number(object.min) : undefined,
      max: isSet(object.max) ? Number(object.max) : undefined,
      zeroThreshold: isSet(object.zeroThreshold) ? Number(object.zeroThreshold) : 0,
    };
  },
  ...
  toJSON(message: ExponentialHistogramDataPoint): unknown {
    ...
    message.zeroCount !== undefined && (obj.zeroCount = Math.round(message.zeroCount));
    message.positive !== undefined &&
      (obj.positive = message.positive ? ExponentialHistogramDataPoint_Buckets.toJSON(message.positive) : undefined);
    message.negative !== undefined &&
      (obj.negative = message.negative ? ExponentialHistogramDataPoint_Buckets.toJSON(message.negative) : undefined);
    message.flags !== undefined && (obj.flags = Math.round(message.flags));
    if (message.exemplars) {
      obj.exemplars = message.exemplars.map((e) => e ? Exemplar.toJSON(e) : undefined);
    } else {
    ...
    message.min !== undefined && (obj.min = message.min);
    message.max !== undefined && (obj.max = message.max);
    message.zeroThreshold !== undefined && (obj.zeroThreshold = message.zeroThreshold);
    return obj;
  },
...
function createBaseSummaryDataPoint(): SummaryDataPoint {
  return { attributes: [], startTimeUnixNano: 0, timeUnixNano: 0, count: 0, sum: 0, quantileValues: [], flags: 0 };
}
...
export const Exemplar = {
  ...
  toJSON(message: Exemplar): unknown {
    ...
    if (message.filteredAttributes) {
      obj.filteredAttributes = message.filteredAttributes.map((e) => e ? KeyValue.toJSON(e) : undefined);
    } else {
...
export const ExportMetricsPartialSuccess = {
  ...
  fromJSON(object: any): ExportMetricsPartialSuccess {
    return {
      rejectedDataPoints: isSet(object.rejectedDataPoints) ? Number(object.rejectedDataPoints) : 0,
  ...
  toJSON(message: ExportMetricsPartialSuccess): unknown {
    const obj: any = {};
    message.rejectedDataPoints !== undefined && (obj.rejectedDataPoints = Math.round(message.rejectedDataPoints));
